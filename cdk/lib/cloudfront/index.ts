...
export class Cloudfront extends Construct {
  ...
  constructor(scope: Construct, id: string, props: IProps) {
    ...
    this.distribution.addBehavior('/testing.js', origin, {
      compress: true,
      cachePolicy: cf.CachePolicy.CACHING_OPTIMIZED,
      responseHeadersPolicy: this.createNoCachePolicy(),
      viewerProtocolPolicy: cf.ViewerProtocolPolicy.REDIRECT_TO_HTTPS,
  ...
  public createNoCachePolicy() {
    return new cf.ResponseHeadersPolicy(this, `${this.id}-no-cache-policy`, {
      comment: 'cache control policy with max-age zero',
